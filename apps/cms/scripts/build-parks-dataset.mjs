...
const parksHtmlPath = path.join(rootDir, 'data/bootstrap/public/data/parks.htm');
const detailCacheDir = path.join(rootDir, 'data/parks/details');
const imageDir = path.join(rootDir, 'data/bootstrap/public/data/parks/images');
const geocodeCachePath = path.join(rootDir, 'data/parks/geocode-cache.json');
const parksOutputPath = path.join(rootDir, 'data/bootstrap/content/parks/parks.generated.json');
const amenitiesOutputPath = path.join(rootDir, 'data/bootstrap/content/parks/amenities.generated.json');
const poolsSourcePath = path.join(rootDir, 'data/bootstrap/content/pools/pools.source.json');
const poolsGeneratedPath = path.join(rootDir, 'data/bootstrap/content/pools/pools.generated.json');
